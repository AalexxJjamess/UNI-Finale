...
%University logo
    ...
    \vspace{3cm}
%Thesis title
    {\uppercase{\Large Optimization of an Axisymmetric, Cardioid Loudspeaker in the Context of Sound Field Control\par}}
    \vspace{3cm}
%Author's 
...
\chapter{Introduction}
    ...
    The prototype serves as a proof of concept, however, that may be used to inspire more practical designs in future. \pdfcomment{I'd like to expand or improve my introduction a bit. Any tips?}
...
\chapter{Background and Theory}
    \section{Sound Field Control and it's Applications}
        ...
        PA loudspeakers are thus designed such that they can be effective not only at producing high sound pressure levels and consistently clear frequency responses, but also effective at controlling a sound field. \pdfcomment{This `theory' section serves more as a brief introduction to each theory, the ore detailed use of each theory is explained in lit. review and methodoology.}
...
\chapter{Methodology, Results and Analysis}
    ...
    \section{Post-Filtering Directivity Measurements}
            ...
            The polar plot of Olson's first-order unidirectional gradient loudspeaker, seen in Fig. \ref{olsonFirstOrderDirectivity}, is much more optimistic and ideally cardioid, matching the polar pattern typically given by a cardioid microphone.\pdfcomment{Should I expand on this?}
